    ...
    const fetchTeamInfo = async () => {
      try {
        ...
        if (actualRecordCount === 0) {
          ...
          console.log(`Direct query result:`, { directCheck, directError });
