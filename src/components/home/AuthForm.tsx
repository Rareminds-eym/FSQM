...
const AuthForm: React.FC<AuthFormProps> = ({ mode, onToggleMode }) => {
  ...
  return (
    <div className={`w-full mx-auto ${
      ...
      <div className="bg-gray-800/60 rounded-lg shadow-2xl relative z-10 w-full mx-auto p-8">
        {/* Form Header */}
        {/* <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-white mb-1">
            {mode === 'login' ? 'Welcome Back' : 'Join FSQM'}
          </h2>
        ...
        {mode === 'signup' ? (
          ...
          >
            ...
            <div className="flex flex-col gap-4"> 
              {/* Full Name */}
              <React.Fragment>
                <label className="block font-medium text-white mb-1 text-sm">Full Name</label>
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 bg-white/10 border border-slate-700/50 rounded-md shadow-sm placeholder-slate-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-white pl-10"
              ...
              {(formData.isTeamLeader || (prefilledTeam && !formData.isTeamLeader)) ? (
                <React.Fragment>
                  <label className="block font-medium text-white mb-1 text-sm">College Code</label>
                  <div className="relative w-full">
                    <input
                      id="collegeCode"
                      name="collegeCode"
                      ...
                      className={`w-full px-4 py-2 bg-white/10 border border-slate-700/50 rounded-md shadow-sm placeholder-slate-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-white ${!formData.isTeamLeader && prefilledTeam ? 'bg-gray-700/40 cursor-not-allowed' : ''}`}
              ...
              {/* Phone Number */}
              <React.Fragment>
                <label className="block font-medium text-white mb-1 text-sm">Phone Number</label>
                <div className="relative w-full">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            <div className="flex flex-col gap-4"> 
              ...
              {formData.isTeamLeader || (prefilledTeam && !formData.isTeamLeader) ? (
                <React.Fragment>
                  <label className="block font-medium text-white mb-1 text-sm">Team Name</label>
                  <div className="relative w-full">
                    <input
                      id="teamName"
                      name="teamName"
                ...
                <React.Fragment>
                  <label className="block font-medium text-white mb-1 text-sm">Join Code</label>
                  <div className="relative w-full">
                    <input
                      id="joinCode"
                      name="joinCode"
                      ...
                      onChange={handleInputChange}
                      required={!formData.isTeamLeader}
                      className="w-full px-4 py-2 bg-white/10 border border-slate-700/50 rounded-md shadow-sm placeholder-slate-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-white"
              ...
              <div className="flex flex-col gap-2">
                <label className="block font-medium text-white mb-1 text-sm">Are you the team leader?</label>
            ...
            <div className="flex flex-col gap-4"> 
              {/* Email */}
              <label className="block font-medium text-white mb-1 text-sm">Email Address</label>
              <div className="relative w-full">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              {/* Password */}
              <label className="block font-medium text-white mb-1 text-sm">Password</label>
              <div className="relative w-full">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full px-4 py-2 bg-white/10 border border-slate-700/50 rounded-md shadow-sm placeholder-slate-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-white pl-10 pr-10"
              ...
              <React.Fragment>
                <label className="block font-medium text-white mb-1 text-sm">Confirm Password</label>
                <div className="relative w-full">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock className="h-5 w-5 text-blue-300" />
                  </div>
