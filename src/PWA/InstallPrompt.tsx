...
export const InstallPrompt: React.FC<InstallPromptProps> = ({ className = '' }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-40 z-40 pointer-events-auto" aria-hidden="true"></div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-medium text-gray-900 dark:text-white">
                {/* Install FSQM Training Game
                 */}
                 Install SafeBite 2.0 Hackathon
              </h3>
